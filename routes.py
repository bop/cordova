...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://bf8f36c45a4091:1730c318@us-cdbr-iron-east-02.cleardb.net/heroku_33c0e58a7864849'
...
def sightings():
    if request.method == 'GET':
        ...
        res.headers['Acces.Control-Allow_Origin'] = '*'
        return res
